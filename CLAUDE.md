...
└── src/
    ...
    └── lib/
        ├── constants.ts        # BRAND, LINKS (xhsStore, githubReleases, jihulabPluginPackages, githubPluginReleases, icpRecord), PRICING ({amount: '¥29.9', originalAmount: '¥99' (strikethrough), label: '永久授权', features: [...]})
