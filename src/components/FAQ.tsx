...
const QUESTIONS: { q: string; a: string }[] = [
  {
    ...
    a: '本质完全不一样。视频包是把 YouTube 上别人的原创视频偷下来打包卖，本质是搬运 + 侵权 + 售卖盗版内容。whatSub 不一样：我们卖软件，处理的是你自己合法访问的 YouTube 视频。视频从 YouTube 加载、字幕在你本地由 Whisper 转录(视频和音频从不上传)、翻译走你自己的 LLM API key。你拥有合法访问权的视频，我们提供更好的看视频和学习工具，不涉及任何版权问题。',
  },
  {
    q: '激活授权码后多久能用?',
