...
const STEPS = [
  {
    num: '01',
    title: '导入',
    body: '粘 YouTube 链接,或拖一个本地 mp4 进来yt-dlp + ffmpeg 自动跑,Cookies 也准备好了应付年龄/地区限制',
  ...
  },
  {
    num: '02',
    title: '本地识别',
    body: 'Whisper 模型在你的 GPU 上跑,5 个档位选择(75 MB → 3 GB)识别完整 22 分钟视频通常 1-3 分钟视频和音频从不上传',
  ...
  },
  {
    num: '03',
    title: '双语播放',
    body: '字幕、词汇、播放器、词汇本在同一个 Player 页里生词 ⭐ 一下进词汇本,字幕里黄底高亮的关键短语点开就有 IPA + 注释 + TTS 朗读',
